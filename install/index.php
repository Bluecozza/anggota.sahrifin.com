...
<html>
    <head>
        <meta charset="UTF-8">
        <title>WoWonder | Installation - Nulled By ADH</title>
                                    ...
                                    <form action="?page=installation" method="post" class="form-horizontal install-site-setting">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <span class="help-block">Enter any thing here, It's Nulled Version. <a target="_blank" href="https://prowebber.ru/">PROWEBBER.RU</a></span>
                                            </div>
                                        </div>
                                        <div class="form-group">
